...
import app.com.randomapps.android.weightlosscalculator.fragments.BMIMetricSystem;
import app.com.randomapps.android.weightlosscalculator.fragments.BMIUsSystem;
...
public class BMICalculator extends AppCompatActivity {
    ...
    public void setupViewPager(ViewPager viewpager) {
        ...
        viewPagerAdapter.addFragment(new BMIUsSystem(), "US Units");
        viewPagerAdapter.addFragment(new BMIMetricSystem(), "Metric Units");
    ...
    public void onUSResultButtonClick(View view) {
        ...
        usAgeID = (EditText) findViewById(R.id.bmi_us_age_input);
        usFeetID = (EditText) findViewById(R.id.bmi_us_height_feet);
        usInchID = (EditText) findViewById(R.id.bmi_us_height_inch);
        usPoundsID = (EditText) findViewById(R.id.bmi_us_weight);
        ...
        Intent intent = new Intent(getBaseContext(), BMIResult.class);
        intent.putExtra("bmi_answer", bmi);
    ...
    public void onMetricResultButtonClicked(View view) {
        ...
        metricAgeID = (EditText) findViewById(R.id.bmi_metric_age_input);
        metricHeightID = (EditText) findViewById(R.id.bmi_metric_height_centimeters);
        metricWeightID = (EditText) findViewById(R.id.bmi_metric_weight);
