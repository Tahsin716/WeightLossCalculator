...
public class CalorieUsSystem extends Fragment {

    public CalorieUsSystem() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.calorie_us_fragment, container, false);

        Spinner spinner = (Spinner) v.findViewById(R.id.calorie_us_spinner);
